...
const Regional = () => {
  ...
  useEffect(() => {
    ...
    function initMap() {
      ...
      window.google.maps.event.addListener(northeastPolygon, 'mouseover', function (event) {
        infoWindow5.setPosition(event.latLng);
  ...
  }, [common_id, region.west_url, region.southwest_url, region.midwest_url, region.south_url, region.northeast_url]);

  return (
    <div className="bg-white">
    <div className="container-fluid mt-3" style={{ fontSize: '20px' }}>
      <div className="row flex-column align-items-center">
        <div className="col-md-7 col-sm-12 align-self-center p-lg-5">
          <h2 className="featurette-heading lh-1 fw-bolder" style={{ fontSize: '30px' }}>
            Regional Signs
          </h2>
          <div id="map" className="mapstyle"></div>
        </div>
        <div className="col-md-5 col-sm align-self-center p-lg-5">
          <h2 className="featurette-heading lh-1 fw-bolder" style={{ fontSize: '30px' }}>
            Common Sign for <span>{region.name}</span>
          </h2>
          <img className="bd-placeholder-img card-img-top m-auto" src={`/${region.common_url}`} alt="" />
          <p><a href="1">strawberry</a> | <a href="2">pizza</a></p>
        </div>
      </div>
    </div>
    </div>
